...
// @ts-ignore`nimport fixtureGymmen from '../../tests/fixtures/av-fasit/AV_U1A21.easyschematic.json';
// @ts-ignore`nimport fixtureStudio from '../../tests/fixtures/av-fasit/AV_H3B19.easyschematic.json';
// @ts-ignore`nimport fixtureAuditorium from '../../tests/fixtures/av-fasit/AV_H1A04.easyschematic.json';

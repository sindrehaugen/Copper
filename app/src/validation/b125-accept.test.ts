...
describe('B125 Accept Criteria - Validator Registry', () => {
  it('detects planted fixture defects for all six validators', () => {
    const doc: DesignDocument = {
      ...
      deviceTypes: [
        { id: 't-poe-sw', manufacturer: 'Cisco', model: 'SW', width: 19, heightRu: 1, depthMm: 200, weightKg: 2, powerPorts: [{ name: 'AC', kind: 'input', maximumDrawWatts: 15 }], networkPorts: [{ name: 'eth1', poeProvided: { standard: '802.3at', budgetWatts: 15 } }] },
        { id: 't-poe-dev', manufacturer: 'Cam', model: 'IP', width: 4, heightRu: 1, depthMm: 50, weightKg: 1, powerPorts: [{ name: 'DC', kind: 'input', allocatedDrawWatts: 25 }], networkPorts: [{ name: 'eth1', poeDrawWatts: 25 }] }, // Exceeds budget
      ...
      devices: [
        { id: 'd-sw', typeId: 't-poe-sw', designator: 'SW1', powerPorts: [{ name: 'AC', kind: 'input', maximumDrawWatts: 15 }] },
        { id: 'd-cam', typeId: 't-poe-dev', designator: 'CAM1', powerPorts: [{ name: 'DC', kind: 'input', allocatedDrawWatts: 25 }] },

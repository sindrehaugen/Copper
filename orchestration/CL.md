...
* [RUNNING] B29 — G.W3 validate-join: two-axis validation → `direct|adapter|incompatible|unknown`; **confirm-warn, never reject** (a drawing is documentation) · tier: T2 · dep: B28 [NO TAG]
...
* [RUNNING] B36 — V.W1 poe-budget: IEEE 802.3 af/at/bt class budget vs switch capacity · tier: T2 · dep: B30 [NO TAG]

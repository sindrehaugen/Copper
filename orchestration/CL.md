...
* [RUNNING] B68b — U.W1b app-shell [SPLIT from B68]: navigation + module-surface registry (router: react-router, MIT — per ADR-0002 amendment), session/tenancy context consuming B75's session, **i18n scaffold (i18next, MIT; nb-NO/en, all copy externalized)** · tier: T2 · dep: B68 [NO TAG]

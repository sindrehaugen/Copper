...
* [RUNNING] B5 — F.W5 es-reader: EasySchematic **format** reader (clean PORT-list port of `fraEasySchematic.js`) → schema · tier: T2 · dep: B4b [FAILED TAG: Silent data drop in auxiliaryData rows, escalate to Pro]

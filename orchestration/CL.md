...
* [RUNNING] B26 — P.W8 integration-proof 🛑→HS-3: seed local NCE with the integration core stack (source: `Documents\integration-AV-Core` files + as-built sheets) via the B13-scope author tool, render read-only via B20–B24, cable schedule out; orchestrator runs the live stack itself · tier: T2 (run-it wave) · dep: B13,B20,B22,B23,B24,B25,B76 [NO TAG]

...
* [RUNNING] B74 — C.W3 ai-transparency: Contract-B confirm dialogs (AI-proposed vs human-decided, provenance shown, confidence never presented as calibrated) as a shared shell component · tier: T3 · dep: B73 [NO TAG]
